/*
	Given a string S.
	In one operation, you can remove the substring "pr" from the string S
	...
	Your task is to complete the function solve() which takes the X ,Y and string S as input parameters
	and returns the maximum amount you can get after performing the above operations.
*/
