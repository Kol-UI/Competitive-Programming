...
namespace CompetitiveProgramming.LeetCode.MaximumDifferenceBetweenEvenandOddFrequencyII;
...
public class TestSolution : BaseSolution
{
	...
	{
        StyleHelper.Space();
        StyleHelper.Title("Maximum Difference Between Even and Odd Frequency II");
