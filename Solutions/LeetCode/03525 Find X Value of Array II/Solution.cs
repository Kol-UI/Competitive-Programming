...
namespace CompetitiveProgramming.LeetCode.FindXValueofArrayII;
...
public class Test
{
    public static bool[] TestCases()
    {
        ...
        bool[] results =
        [
            ResultTester.CheckResult<int[]>(solution.ResultArray([1,2,3,4,5], 3, [[2,2,0,2],[3,3,3,0],[0,1,0,1]]), [2,2,2]),
            ResultTester.CheckResult<int[]>(solution.ResultArray([1,2,4,8,16,32], 4, [[0,2,0,2],[0,2,0,1]]), [1,0]),
            ResultTester.CheckResult<int[]>(solution.ResultArray([1,1,2,1,1], 2, [[2,1,0,1]]), [5]),
        ];
        return results;
    }
}
...
public class TestSolution : BaseSolution
{
    ...
    {
        StyleHelper.Space();
        StyleHelper.Title("Find X Value of Array II");
