...
namespace CompetitiveProgramming.LeetCode.KthSmallestAmountWithSingleDenominationCombination;
...
public class Test
{
    public static bool[] TestCases()
    {
        ...
        bool[] results =
        [
            ResultTester.CheckResult<long>(solution.FindKthSmallest([3,6,9], 3), 9),
            ResultTester.CheckResult<long>(solution.FindKthSmallest([5,2], 7), 12),
        ];
        return results;
    }
}
...
public class TestSolution : BaseSolution
{
    ...
    {
        StyleHelper.Space();
        StyleHelper.Title("Kth Smallest Amount With Single Denomination Combination");
