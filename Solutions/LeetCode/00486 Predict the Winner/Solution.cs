...
namespace CompetitiveProgramming.LeetCode.PredicttheWinner
{
    ...
    public class TestSolution : Models.BaseSolution
    {
        public override void GetResult()
        {
            ...
            Helpers.StyleHelper.Title("Predict the Winner");
            ResultTester.CheckCurrentSolution(ProblemOrigin.LeetCode, ProblemCategory.MediumLC, Test.TestPredicttheWinner());
        }
    }
}