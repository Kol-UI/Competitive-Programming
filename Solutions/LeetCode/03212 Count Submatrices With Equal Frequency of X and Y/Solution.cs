...
namespace CompetitiveProgramming.LeetCode.CountSubmatricesWithEqualFrequencyofXandY;
...
public class TestSolution : BaseSolution
{
    ...
    {
        StyleHelper.Space();
        StyleHelper.Title("Count Submatrices With Equal Frequency of X and Y");
