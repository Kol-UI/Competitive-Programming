...
namespace CompetitiveProgramming.LeetCode.SearchSuggestionsSystem
{
    ...
    public class TestSolution : Models.BaseSolution
    {
        public override void GetResult()
        {
            ...
            Helpers.StyleHelper.Title("Search Suggestions System");
            ResultTester.CheckCurrentSolution(ProblemOrigin.LeetCode, ProblemCategory.MediumLC, Test.TestSearchSuggestionsSystem());
        }
    }
}