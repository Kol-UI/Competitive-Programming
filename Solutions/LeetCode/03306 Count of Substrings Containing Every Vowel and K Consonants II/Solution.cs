...
namespace CompetitiveProgramming.LeetCode.CountofSubstringsContainingEveryVowelandKConsonantsII;
...
public class TestSolution : BaseSolution
{
    ...
    {
        StyleHelper.Space();
        StyleHelper.Title("Count of Substrings Containing Every Vowel and K Consonants II");
