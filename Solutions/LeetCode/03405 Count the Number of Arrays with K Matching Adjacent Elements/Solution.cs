...
namespace CompetitiveProgramming.LeetCode.CounttheNumberofArrayswithKMatchingAdjacentElements;
...
public class TestSolution : BaseSolution
{
	...
	{
        StyleHelper.Space();
        StyleHelper.Title("Count the Number of Arrays with K Matching Adjacent Elements");
