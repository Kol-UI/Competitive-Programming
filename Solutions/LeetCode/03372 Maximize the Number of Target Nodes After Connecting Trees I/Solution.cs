...
namespace CompetitiveProgramming.LeetCode.MaximizetheNumberofTargetNodesAfterConnectingTreesI;
...
public class TestSolution : BaseSolution
{
	...
	{
        StyleHelper.Space();
        StyleHelper.Title("Maximize the Number of Target Nodes After Connecting Trees I");
