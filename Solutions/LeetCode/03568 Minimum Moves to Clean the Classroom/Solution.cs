...
namespace CompetitiveProgramming.LeetCode.MinimumMovestoCleantheClassroom;
...
public class Test
{
    public static bool[] TestCases()
    {
        ...
        bool[] results =
        [
            ResultTester.CheckResult<int>(solution.MinMoves(["S.", "XL"], 2), 2),
            ResultTester.CheckResult<int>(solution.MinMoves(["LS", "RL"], 4), 3),
            ResultTester.CheckResult<int>(solution.MinMoves(["L.S", "RXL"], 3), -1),
        ];
        return results;
    }
}
...
public class TestSolution : BaseSolution
{
    ...
    {
        StyleHelper.Space();
        StyleHelper.Title("Minimum Moves to Clean the Classroom");
