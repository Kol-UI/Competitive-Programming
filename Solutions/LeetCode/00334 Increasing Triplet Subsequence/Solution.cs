...
namespace CompetitiveProgramming.LeetCode.IncreasingTripletSubsequence
{
    ...
    public class Test
    {
        public static bool[] TestIncreasingTripletSubsequence()
        {
            ...
            bool result1 = Solution.IncreasingTriplet(Case1);
            bool result2 = Solution.IncreasingTriplet(Case2);
            bool result3 = Solution.IncreasingTriplet(Case3);
            bool result4 = Solution.IncreasingTriplet(Case4);
            bool result5 = Solution.IncreasingTriplet(Case5);
            bool result6 = Solution.IncreasingTriplet(Case6);
            bool result7 = Solution.IncreasingTriplet(Case7);
            bool result8 = Solution.IncreasingTriplet(Case8);
            bool result9 = Solution.IncreasingTriplet(Case9);
            bool result10 = Solution.IncreasingTriplet(Case10);
            bool result11 = Solution.IncreasingTriplet(Case11);
            bool result12 = Solution.IncreasingTriplet(Case12);
            bool result13 = Solution.IncreasingTriplet(Case13);
            bool result14 = Solution.IncreasingTriplet(Case14);
            bool result15 = Solution.IncreasingTriplet(Case15);
            bool result16 = Solution.IncreasingTriplet(Case16);
            bool result17 = Solution.IncreasingTriplet(Case17);
            bool result18 = Solution.IncreasingTriplet(Case18);
            bool result19 = Solution.IncreasingTriplet(Case19);
            bool result20 = Solution.IncreasingTriplet(Case20);
            bool result21 = Solution.IncreasingTriplet(Case21);
            bool result22 = Solution.IncreasingTriplet(Case22);
            bool result23 = Solution.IncreasingTriplet(Case23);
            bool result24 = Solution.IncreasingTriplet(Case24);
            bool result25 = Solution.IncreasingTriplet(Case25);
            bool result26 = Solution.IncreasingTriplet(Case26);
            bool result27 = Solution.IncreasingTriplet(Case27);
            bool result28 = Solution.IncreasingTriplet(Case28);
            bool result29 = Solution.IncreasingTriplet(Case29);
            bool result30 = Solution.IncreasingTriplet(Case30);
            bool result31 = Solution.IncreasingTriplet(Case31);
            bool result32 = Solution.IncreasingTriplet(Case32);
            bool result33 = Solution.IncreasingTriplet(Case33);
            bool result34 = Solution.IncreasingTriplet(Case34);
            bool result35 = Solution.IncreasingTriplet(Case35);
            bool result36 = Solution.IncreasingTriplet(Case36);
            bool result37 = Solution.IncreasingTriplet(Case37);
            bool result38 = Solution.IncreasingTriplet(Case38);
            bool result39 = Solution.IncreasingTriplet(Case39);
            bool result40 = Solution.IncreasingTriplet(Case40);
            bool result41 = Solution.IncreasingTriplet(Case41);
            bool result42 = Solution.IncreasingTriplet(Case42);
    ...
    public class TestSolution : BaseSolution
    {
        public override void GetResult()
        {
            ...
            ResultTester.CheckCurrentSolution(ProblemOrigin.LeetCode, ProblemCategory.MediumLC, Test.TestIncreasingTripletSubsequence());
        }
    }
}