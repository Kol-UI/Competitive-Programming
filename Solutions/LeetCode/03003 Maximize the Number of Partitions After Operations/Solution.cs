...
namespace CompetitiveProgramming.LeetCode.MaximizetheNumberofPartitionsAfterOperations;
...
public class TestSolution : BaseSolution
{
    ...
    {
        StyleHelper.Space();
        StyleHelper.Title("Maximize the Number of Partitions After Operations");
