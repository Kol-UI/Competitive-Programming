...
namespace CompetitiveProgramming.LeetCode.DesignBrowserHistory
{
    /*
    ...
    public class BrowserHistory
    {
        ...
        public BrowserHistory(string homepage) {
            var node = new ListNode(homepage);    
            _current = node;
        }
        ...
        public string Back(int steps) {
            ...
            while(_current.prev is not null && steps !=0)
            {
        ...
        public string Forward(int steps) {
            while(_current.next is not null && steps!=0)
            {
    ...
    */
    ...
    public class TestSolution : Models.BaseSolution
    {
        public override void GetResult()
        {
            ...
            Helpers.StyleHelper.Title("Design Browser History");
