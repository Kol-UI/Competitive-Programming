...
namespace CompetitiveProgramming.LeetCode.MinimumDifferenceinSumsAfterRemovalofElements;
...
public class TestSolution : BaseSolution
{
    ...
    {
        StyleHelper.Space();
        StyleHelper.Title("Minimum Difference in Sums After Removal of Elements");
