...
namespace CompetitiveProgramming.LeetCode.MaximumScoreFromGridOperations;
...
public class Test
{
    public static bool[] TestCases()
    {
        ...
        bool[] results =
        [
            ResultTester.CheckResult<long>(solution.MaximumScore([[0,0,0,0,0],[0,0,3,0,0],[0,1,0,0,0],[5,0,0,3,0],[0,0,0,0,2]]), 11),
            ResultTester.CheckResult<long>(solution.MaximumScore([[10,9,0,0,15],[7,1,0,8,0],[5,20,0,11,0],[0,0,0,1,2],[8,12,1,10,3]]), 94),
        ];
        return results;
    }
}
...
public class TestSolution : BaseSolution
{
    ...
    {
        StyleHelper.Space();
        StyleHelper.Title("Maximum Score From Grid Operations");
