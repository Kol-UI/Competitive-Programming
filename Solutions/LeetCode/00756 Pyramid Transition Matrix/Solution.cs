...
namespace CompetitiveProgramming.LeetCode.PyramidTransitionMatrix;
...
public class Test
{
    public static bool[] TestCases()
    {
        ...
        {
            ResultTester.CheckResult<bool>(solution.PyramidTransition("BCD",["BCC","CDE","CEA","FFF"]), true),
            ResultTester.CheckResult<bool>(solution.PyramidTransition("AAAA",["AAB","AAC","BCD","BBE","DEF"]), false)
        };
        return results;
    }
}
...
public class TestSolution : BaseSolution
{
    ...
    {
        StyleHelper.Space();
        StyleHelper.Title("Pyramid Transition Matrix");
