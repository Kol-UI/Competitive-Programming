...
namespace CompetitiveProgramming.Services.Providers
{
    public class LeetCodeServices : ILeetCodeServices
    {
        ...
        {
            ShortestBridgeFunc, New21GameFunc, LongestArithmeticSubsequenceFunc, MaximalNetworkRankFunc, UncrossedLinesFunc, MinimumNumberofArrowstoBurstBalloonsFunc, ShuffleanArrayFunc, LengthofLongestSubarrayWithatMostKFrequencyFunc,
        ...
        {
            StyleHelper.Space();
            StyleHelper.Title("Minimum Cost to Hire K Workers");
            ResultTester.CheckSolution(ProblemOrigin.LeetCode, LeetCode.MinimumCosttoHireKWorkers.Test.TestCases());
        }

        private static void KthSmallestPrimeFractionFunc()
        {
            StyleHelper.Space();
            StyleHelper.Title("K-th Smallest Prime Fraction");
            ResultTester.CheckSolution(ProblemOrigin.LeetCode, LeetCode.KthSmallestPrimeFraction.Test.TestCases());
        }

        private static void MaximizeHappinessofSelectedChildrenFunc()
        {
            StyleHelper.Space();
            StyleHelper.Title("Maximize Happiness of Selected Children");
            ResultTester.CheckSolution(ProblemOrigin.LeetCode, LeetCode.MaximizeHappinessofSelectedChildren.Test.TestCases());
        }
        ...
        private static void AppendCharacterstoStringtoMakeSubsequenceFunc()
        {
            StyleHelper.Space();
            StyleHelper.Title("Append Characters to String to Make Subsequence");
            ResultTester.CheckSolution(ProblemOrigin.LeetCode, LeetCode.AppendCharacterstoStringtoMakeSubsequence.Test.TestCases());
        }
        ...
        private static void HandofStraightsFunc()
        {
            StyleHelper.Space();
            StyleHelper.Title("Hand of Straights");
            ResultTester.CheckSolution(ProblemOrigin.LeetCode, LeetCode.HandofStraights.Test.TestCases());
        }
        ...
        private static void ContinuousSubarraySumFunc()
        {
            StyleHelper.Space();
            StyleHelper.Title("Continuous Subarray Sum");
            ResultTester.CheckSolution(ProblemOrigin.LeetCode, LeetCode.ContinuousSubarraySum.Test.TestCases());
        }
        ...
        private static void GetEqualSubstringsWithinBudgetFunc()
        {
            StyleHelper.Space();
            StyleHelper.Title("Get Equal Substrings Within Budget");
        ...
        {
            StyleHelper.Space();
            StyleHelper.Title("Replace Words");
            ResultTester.SpecialTestCase(ProblemOrigin.LeetCode);
        }

        private static void FindCommonCharactersFunc()
        {
            StyleHelper.Space();
        ...
        private static void TheNumberofBeautifulSubsetsFunc()
        {
            StyleHelper.Space();
            StyleHelper.Title("The Number of Beautiful Subsets");
            ResultTester.SpecialTestCase(ProblemOrigin.LeetCode);
        }

        private static void MaximumScoreWordsFormedbyLettersFunc()
        {
            StyleHelper.Space();
        ...
        private static void FindtheNumberofGoodPairsIFunc()
        {
            StyleHelper.Space();
        ...
        private static void DistributeCoinsinBinaryTreeFunc()
        {
            StyleHelper.Space();
            StyleHelper.Title("Distribute Coins in Binary Tree");
            ResultTester.SpecialTestCase(ProblemOrigin.LeetCode);
        }

        private static void DeleteLeavesWithaGivenValueFunc()
        {
            StyleHelper.Space();
            StyleHelper.Title("Delete Leaves With a Given Value");
            ResultTester.SpecialTestCase(ProblemOrigin.LeetCode);
        }

        private static void ScoreAfterFlippingMatrixFunc()
        {
            StyleHelper.Space();
            StyleHelper.Title("Score After Flipping Matrix");
            ResultTester.SpecialTestCase(ProblemOrigin.LeetCode);
        }
