...
namespace CompetitiveProgramming.TestDrivenDevelopment
{
    public class CSharpTDD
    {
        ...
        private static void FindMissingandRepeatedValuesFunc()
        {
            ...
            ResultTester.CheckSolution("LC", LeetCode.FindMissingandRepeatedValues.Test.TestCases());
        }
        ...
        private static void MaximumProductDifferenceBetweenTwoPairsFunc()
        {
            ...
            ResultTester.CheckSolution("LC", LeetCode.MaximumProductDifferenceBetweenTwoPairs.Test.TestCases());
        }
        ...
        private static void ImageSmootherFunc()
        {
            ...
            ResultTester.CheckSolution("LC", LeetCode.ImageSmoother.Test.TestCases());
        }
        ...
        private static void BuyTwoChocolatesFunc()
        {
            ...
            ResultTester.CheckSolution("LC", LeetCode.BuyTwoChocolates.Test.TestCases());
        }
        ...
        private static void ExcelSheetColumnNumberFunc()
        {
            ...
            ResultTester.CheckSolution("LC", LeetCode.ExcelSheetColumnNumber.Test.TestCases());
        }
