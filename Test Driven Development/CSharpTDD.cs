...
namespace CompetitiveProgramming.TestDrivenDevelopment
{
    public class CSharpTDD
    {
        ...
        {
            Program.Space();
            Program.Title("Find Common Elements Between Two Arrays");
        ...
        {
            Program.Space();
            Program.Title("Diameter of Binary Tree");
            ResultTester.SpecialTestCase("LC");
        }
        ...
        {
            Program.Space();
            Program.Title("Maximum Running Time of N Computers");
        ...
        {
            Program.Space();
            Program.Title("Minimum ASCII Delete Sum for Two Strings");
        ...
        {
            Program.Space();
            Program.Title("Combination Sum II");
        ...
        {
            Program.Space();
            Program.Title("I Wanna Be the Guy");
            ResultTester.SpecialTestCase("CF");
        }
        ...
        {
            Program.Space();
            Program.Title("Maximum Number of Coins You Can Get");
        ...
        {
            Program.Space();
            Program.Title("Determine Whether Matrix Can Be Obtained By Rotation");
        ...
        {
            Program.Space();
            Program.Title("Find the Smallest Divisor Given a Threshold");
        ...
        {
            Program.Space();
            Program.Title("Split Linked List in Parts");
            ResultTester.SpecialTestCase("LC");
        }
        ...
        {
            Program.Space();
            Program.Title("Search a 2D Matrix II");
        ...
        {
            Program.Space();
            Program.Title("Insert Delete GetRandom O(1)");
            ResultTester.SpecialTestCase("LC");
        }
        ...
        {
            Program.Space();
            Program.Title("Reverse Linked List II");
            ResultTester.SpecialTestCase("LC");
        }
        ...
        {
            Program.Space();
            Program.Title("Minimum Depth of Binary Tree");
            ResultTester.SpecialTestCase("LC");
        }
        ...
        {
            Program.Space();
            Program.Title("All Nodes Distance K in Binary Tree");
            ResultTester.SpecialTestCase("LC");
        }
        ...
        {
            Program.Space();
            Program.Title("Maximize the Confusion of an Exam");
        ...
        {
            Program.Space();
            Program.Title("Longest Palindrome by Concatenating Two Letter Words");
        ...
        {
            Program.Space();
            Program.Title("Put Marbles in Bags");
        ...
        {
            Program.Space();
            Program.Title("Count All Valid Pickup and Delivery Options");
        ...
        {
            Program.Space();
            Program.Title("Group the People Given the Group Size They Belong To");
        ...
        {
            Program.Space();
            Program.Title("Minimum Deletions to Make Character Frequencies Unique");
        ...
        {
            Program.Space();
            Program.Title("Min Cost to Connect All Points");
        ...
        {
            Program.Space();
            Program.Title("Reconstruct Itinerary");
            ResultTester.SpecialTestCase("LC");
        }
        ...
        {
            Program.Space();
            Program.Title("Stones on the Table");
            ResultTester.SpecialTestCase("CF");
        }
        ...
        {
            Program.Space();
            Program.Title("Maximum Product of Two Elements in an Array");
        ...
        {
            Program.Space();
            Program.Title("Special Positions in a Binary Matrix");
        ...
        {
            Program.Space();
            Program.Title("Remove Duplicate Letters");
        ...
        {
            Program.Space();
            Program.Title("Remove Colored Pieces if Both Neighbors are the Same Color");
        ...
        {
            Program.Space();
            Program.Title("Number of Good Pairs");
        ...
        {
            Program.Space();
            Program.Title("Majority Element II");
        ...
        {
            Program.Space();
            Program.Title("Build Array Where You Can Find The Maximum Exactly K Comparisons");
        ...
        {
            Program.Space();
            Program.Title("Max Dot Product of Two Subsequences");
        ...
        {
            Program.Space();
            Program.Title("Minimum Number of Operations to Make Array Continuous");
        ...
        {
            Program.Space();
            Program.Title("Maximum Score of a Good Subarray");
        ...
        {
            Program.Space();
            Program.Title("Painting the Walls");
            ResultTester.SpecialTestCase("LC");
        }
        ...
        {
            Program.Space();
            Program.Title("Number of Ways to Stay in the Same Place After Some Steps");
        ...
        {
            Program.Space();
            Program.Title("Validate Binary Tree Nodes");
            ResultTester.SpecialTestCase("LC");
        }
        ...
        {
            Program.Space();
            Program.Title("Constrained Subsequence Sum");
        ...
        {
            Program.Space();
            Program.Title("Find the Winner of an Array Game");
        ...
        {
            Program.Space();
            Program.Title("Minimum Sum of Mountain Triplets I");
        ...
        {
            Program.Space();
            Program.Title("George and Accommodation");
        ...
        {
            Program.Space();
            Program.Title("Count Number of Homogenous Substrings");
        ...
        {
            Program.Space();
            Program.Title("Restore the Array From Adjacent Pairs");
        ...
        {
            Program.Space();
            Program.Title("Maximum Strong Pair XOR I");
        ...
        {
            Program.Space();
            Program.Title("Sort Vowels in a String");
        ...
        {
            Program.Space();
            Program.Title("Find Unique Binary String");
        ...
        {
            Program.Space();
            Program.Title("Minimize Maximum Pair Sum in Array");
        ...
        {
            Program.Space();
            Program.Title("Distribute Candies");
        ...
        {
            Program.Space();
            Program.Title("Minimum Amount of Time to Collect Garbage");
        ...
        {
            Program.Space();
            Program.Title("Valid Palindrome");
        ...
        {
            Program.Space();
            Program.Title("Sum of Absolute Differences in a Sorted Array");
        ...
        {
            Program.Space();
            Program.Title("Largest Submatrix With Rearrangements");
        ...
        {
            Program.Space();
            Program.Title("Number of Ways to Divide a Long Corridor");
        ...
        {
            Program.Space();
            Program.Title("Minimum One Bit Operations to Make Integers Zero");
        ...
        {
            Program.Space();
            Program.Title("Find Words Containing Character");
        ...
        {
            Program.Space();
            Program.Title("Destination City");
