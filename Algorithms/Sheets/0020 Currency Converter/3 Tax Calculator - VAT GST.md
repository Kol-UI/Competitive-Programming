Tax Calculator (VAT/GST)

Calculates tax amounts and final prices given a rate.
Supports both VAT (tax-inclusive) and GST (tax-exclusive) models.
Provides multiple rounding strategies for different regional requirements.
