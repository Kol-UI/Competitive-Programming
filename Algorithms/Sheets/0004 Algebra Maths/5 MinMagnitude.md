Returns the smaller magnitude of two double-precision floating-point numbers. Magnitude = distance to 0. Also when magnitude is egal, return the negative value.
```cs
